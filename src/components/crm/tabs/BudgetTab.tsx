                                  ...
                                  {item.tranches!.map((tranche) => (
                                    <div key={tranche.id} className="flex items-center gap-1.5 px-2 py-1.5 border-b border-gray-100 last:border-0 bg-white">
                                      <input
                                        ...
                                        className="h-6 flex-1 text-[10px] border border-gray-200 rounded px-1.5 bg-white focus:border-indigo-400 outline-none disabled:bg-transparent disabled:border-transparent"
                                      />
                                      <Input
                                        type="number"
                                        ...
                                        className={cn('h-6 w-20 text-right text-xs disabled:opacity-100 disabled:bg-transparent disabled:border-transparent', isOverBudget ? 'border-red-400 bg-red-50/50' : '')}
                                      />
                                      {canEditOrders && (
                              ...
                              <div className="flex items-center gap-2">
                                <div className="flex-1">
                                  ...
                                  <Input
                                    ...
                                    disabled={!canEditOrders}
                                    onChange={(e) => updateBudgetItemPlan(order.id, item.id, Math.max(0, Number(e.target.value)))}
                                    className="h-6 text-right text-xs font-semibold p-1 border-gray-200 w-full disabled:bg-transparent disabled:border-transparent"
                                  />
                                </div>
                                <div className="w-[1px] bg-gray-200 self-stretch" />
                                <div className="shrink-0 text-right">
                              ...
                              {!item.hasTranches && (
                                <div className="mt-1.5">
                                  <input
                                    ...
                                    disabled={!canEditOrders}
                                    onChange={(e) => updateBudgetItemDate(order.id, item.id, e.target.value, item.plan)}
                                    className="h-7 w-full text-[10px] border border-gray-200 rounded px-2 focus:border-indigo-400 outline-none text-gray-500 bg-white disabled:bg-transparent disabled:border-transparent"
                                  />
                                </div>
                              )}
                              {hasTranches && (
                                  ...
                                  {item.tranches!.map((tranche) => (
                                    <div key={tranche.id} className="flex items-center gap-1.5 px-2 py-1.5 border-b border-gray-100 last:border-0 bg-white">
                                      ...
                                      <Input type="number" value={tranche.amount}
                                        disabled={!canEditOrders}
                                        onChange={(e) => updateTranche(order.id, item.id, tranche.id, { amount: Math.max(0, Number(e.target.value)) })}
                                        className="h-6 w-20 text-right text-xs disabled:opacity-100 disabled:bg-transparent disabled:border-transparent" />
                                      {canEditOrders && (
                    ...
                    {visibleItems.map((item) => {
                      ...
                      return (
                        <React.Fragment key={item.id}>
                            ...
                            <TableCell className="text-right">
                              <div className="flex flex-col gap-1 items-end ml-auto w-fit">
                                <Input
                                  ...
                                  className="h-8 w-28 text-right text-sm font-medium disabled:bg-transparent disabled:border-transparent"
                                />
                                {!item.hasTranches && (
                                  <div className="relative">
                                    <input
                                      ...
                                      className="h-7 w-28 text-xs border border-gray-200 rounded px-1.5 focus:border-indigo-400 focus:ring-1 focus:ring-indigo-400/50 outline-none transition-colors text-gray-500 cursor-pointer hover:border-gray-300 disabled:bg-transparent disabled:border-transparent"
                                  ...
                                  <TableCell className="pl-12">
                                    <div className="flex items-center gap-2">
                                      ...
                                      <input
                                        ...
                                        className="h-7 w-[140px] text-xs border border-gray-200 rounded px-2 bg-white hover:border-gray-300 focus:border-indigo-400 focus:ring-1 focus:ring-indigo-400/50 outline-none transition-colors disabled:bg-transparent disabled:border-transparent"
                                      />
                                      {tranche.plannedDate && (
                                  ...
                                  <TableCell className="text-right" colSpan={2}>
                                    <div className="flex items-center justify-end gap-2">
                                      <Input
                                        ...
                                        className={cn(
                                          'h-7 w-28 text-right text-xs ml-auto disabled:bg-transparent disabled:border-transparent',
                                          isOverBudget
                          ...
                          {hasTranches && !item.hasTranches && canEditOrders && (
